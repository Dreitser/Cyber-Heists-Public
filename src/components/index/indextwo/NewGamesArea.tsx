        ...
        <div className="row justify-content-center">
          <div className="col-xl-6 col-lg-8">
            <div className="section-title title-style-three text-center mb-20">
              <h2>
                space <span>HEIST</span>
              </h2>
              <p>
              Futuristic, High Stakes Art Heist Multiplayer Co-Op ROUGELIKE 
              Made in Unreal Free-to-Play Non-Obligitory NFT
              </p>
            </div>
          </div>
        </div>
            ...
            >
              <div className="released-game-carousel">
                <div className="released-game-item">
                  ...
                  <div className="released-game-img">
                    <img
                      src="assets/img/images/released_game_img01.jpg"
                      alt=""
                    />
                  </div>
              ...
              <div className="released-game-carousel">
                <div className="released-game-item">
                  ...
                  <div className="released-game-img">
                    <img
                      src="assets/img/images/released_game_img02.jpg"
                      alt=""
                    />
                  </div>
                  <div className="released-game-content">
              ...
              <div className="released-game-carousel">
                <div className="released-game-item">
                  ...
                  <div className="released-game-img">
                    <img
                      src="assets/img/images/released_game_img03.jpg"
                      alt=""
                    />
                  </div>
                  <div className="released-game-content">
