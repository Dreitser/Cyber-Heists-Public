...
const CLUSTER = (import.meta.env.VITE_CLUSTER || "testnet") as Cluster;
const TRANSFER_AMOUNT = LAMPORTS_PER_SOL * 0.01;

const senderSecretKey = import.meta.env.VITE_SENDER_SECRET_KEY || "";
const senderKeypair = Keypair.fromSecretKey(decode(senderSecretKey));

const nonceAuthSecretKey = import.meta.env.VITE_NONCE_AUTH_SECRET_KEY || "";
